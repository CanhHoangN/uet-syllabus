            ...
            <div class="header">
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        @if(Auth::check())
                        <div class="btn-group">
                            <button type="button" class="btn btn-outline-success"><a href="#">{{Auth::user()->name}}</a></button>
                            <button type="button" class="btn btn-outline-danger"><a href={{route('logout')}}>Logout</a></button>
                        </div>
                        @else
                        <div class="btn-group">
                            <button type="button" class="btn btn-outline-success"><a href={{route('login')}}>Login</a></button>
                            <button type="button" class="btn btn-outline-danger"><a href={{route('register')}}>Register</a></button>
                        </div>
                        @endif
                    </div>
                </div>
                    ...
                    <form action="{!! url('save') !!}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="outcome">
                            <div class="bg-danger">
                                ...
                                <textarea id="box-outcome-2" class="bg-danger out-text" name="text-box-value1"></textarea>
                        ...
                        <div class="teaching">
                            <div class="bg-success">
                                ...
                                <textarea id="box-teaching" class="bg-success teach-text" name="text-box-value2"></textarea>
                            </div>
                        </div>
                        <button type="submit" name="save" class="copy-print btn-outline-warning">
                            Save
                        </button>
                    </form>
                </div>
